...
AndroidDriver: class extends Driver {
	...
	collectSourceFolders: func ~sourceFolders (sourceFolder: SourceFolder, modulesDone := ArrayList<Module> new(), sourceFoldersDone := ArrayList<SourceFolder> new()) -> List<SourceFolder> {
		for (module in sourceFolder modules) {
	...
	collectSourceFolders: func ~modules (module: Module, modulesDone := ArrayList<Module> new(), sourceFoldersDone := ArrayList<SourceFolder> new()) -> List<SourceFolder> {
